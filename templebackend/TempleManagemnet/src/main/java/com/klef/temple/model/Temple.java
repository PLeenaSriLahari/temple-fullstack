...
public class Temple {
    ...
    @Column(name = "lord_name", nullable = false, length = 50)
	...
	public String toString() {
		return "Temple [templeId=" + templeId + ", name=" + name + ", location=" + location + ", lordName=" + lordName
